...
SHADCN_ALIASES = {
    ...
    "foreground": "var(--color-txt-neutral-p1-active)",
    "card": "var(--color-surface-neutral-light-active)",
    "card-foreground": "var(--color-txt-neutral-p1-active)",
    "popover": "var(--color-surface-neutral-light-active)",
    "popover-foreground": "var(--color-txt-neutral-p2-active)",
    ...
    "muted-foreground": "var(--color-txt-neutral-p3-active)",
    "accent": "var(--color-fill-neutral-light-hover)",
    "accent-foreground": "var(--color-txt-neutral-p2-active)",
    ...
    "sidebar-foreground": "var(--color-txt-neutral-p2-active)",
