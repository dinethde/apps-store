      ...
      >
        <ComboboxPrimitive.Popup
          ...
          className={cn(
            ...
            w-(--anchor-width) max-w-(--available-width) min-w-(--anchor-width)
            ...
            *:data-[slot=input-group]:shadow-none data-open:animate-in
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        ...
        transition-colors focus-within:border-ring focus-within:ring-3
        focus-within:ring-ring/50 has-aria-invalid:border-destructive
        has-aria-invalid:ring-3 has-aria-invalid:ring-destructive/20
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        ...
        text-foreground has-disabled:pointer-events-none
